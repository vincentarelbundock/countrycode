...
The `countrycode` repository holds several custom dictionaries: https://github.com/vincentarelbundock/countrycode/tree/main/custom_dictionaries

To add your own custom dictionary, please make sure that:

1. You save a comma-separated CSV file that looks something like custom_dictionaries/data_us_states.csv
...
state_dict <- "https://raw.githubusercontent.com/vincentarelbundock/countrycode/main/custom_dictionaries/data_us_states.csv"
