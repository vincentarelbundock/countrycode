...
#set document(title: [Country codes])

#metadata((
  title: "Country codes",
  summary: "Convert single codes and whole vectors between coding schemes, merge datasets on a shared identifier, and control matching with custom dictionaries, fallback destinations, and custom matches.",
)) <website-metadata>
...
#figure(
  image(
    "/assets/gt_flags.png",
    width: 40%,
    alt: "A gt table with country names and their unicode flags",
  ),
  caption: [Unicode flags rendered by the `gt` package.],
)
