...
tmp <- read.csv(here("r/data/custom_dictionaries/data_global_burden_of_disease.csv")) |>
    unique() |>
...
saveRDS(tmp, here("r/data/custom_dictionaries/data_global_burden_of_disease.rds"))
