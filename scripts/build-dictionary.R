...
dat <- list()
dat$regex <- read_csv(file.path(dictionary_dir, "data_regex.csv"), col_types = cols(), progress = FALSE)
...
save(codelist, file = file.path(package_data_dir, "codelist.rda"), compress = "xz", version = 2)
save(codelist_panel, file = file.path(package_data_dir, "codelist_panel.rda"), compress = "xz", version = 2)
...
write_csv(codelist_without_cldr, file.path(dictionary_dir, "codelist_without_cldr.csv"), na = "")
write_csv(codelist_panel_without_cldr, file.path(dictionary_dir, "codelist_panel_without_cldr.csv"), na = "")
